...
export default function MetadataPanel({ recentPredictions }: MetadataPanelProps) {
  ...
  return (
    <Card className="lg:col-span-1 border-border bg-card">
      <CardHeader>
        ...
        <CardDescription>System information & recent predictions</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-accent rounded-lg p-4 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-foreground">12.4 kWh</span>
            </div>
            <div className="flex justify-between">
              <span className="text-xs text-muted-foreground">Last Updated</span>
              <span className="text-sm font-medium text-foreground">Dec 25, 2025</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData}>
                  ...
                  <XAxis dataKey="name" tick={{ fill: "hsl(var(--color-muted-foreground))", fontSize: 12 }} />
                  <YAxis tick={{ fill: "hsl(var(--color-muted-foreground))", fontSize: 12 }} />
                  <Tooltip
                    contentStyle={{
                    ...
                    formatter={(value) => (typeof value === "number" ? `${value.toFixed(1)}k kWh` : `${value} kWh`)}
                  />
                  <Bar dataKey="value" fill="hsl(from var(--color-chart-1) h s l)" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ) : (
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-semibold text-foreground">Typical Usage</h3>
